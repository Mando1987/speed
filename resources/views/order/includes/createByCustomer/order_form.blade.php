<form class="OrderFormSubmit" action="{{ route('order.store') }}" method="POST">
    ...
    <div class="order-info">
        @include('order.includes.progressbar',['title'=> __('site.order_info_title'), 'progress' => 100, 'selected' =>
        2,'count' => 2])
        <div class="row">
            <div class="col-md">
                <!-- start col-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select class="custom-select" name="order[type]">
                                ...
                                <option value="international_shipping">@lang('site.order_international_shipping')
                                </option>
                                <option value="packaging_service">@lang('site.order_packaging_service')</option>
                                <option value="correspondents_service">@lang('site.order_correspondents_service')
                                </option>
                ...
                <div class="col-md">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="shipping[weight]" class="form-control  " id="order_weight"
                ...
                <div class="col-md">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="shipping[quantity]" class="form-control   " id="order_quantity"
                ...
                <div class="col-md">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="shipping[price]" class="form-control  " id="order_price"
                ...
                <div class="col-md">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="order[info]" class="form-control " id="order_info" rows="1"
                ...
                <div class="col-md">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="order[notes]" class="form-control" id="order_notes" rows="1"
            ...
            <div class="col-md">
                ...
                <div class="col-md">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="shipping[total_weight]" class="form-control"
                ...
                <div class="col-md">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="shipping[total_over_weight]" class="form-control"
                                id="order_total_over_weight" placeholder="@lang('site.order_total_over_weight')"
                                readonly>
                        </div>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="shipping[total_over_weight_price]" class="form-control"
                ...
                <div class="col-md">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="shipping[charge_price]" class="form-control"
                ...
                <div class="col-md">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="shipping[total_price]" class="form-control" id="order_total_price"
