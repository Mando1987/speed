            ...
            <div class="tab-content p-0">
                ...
                <div class="tab-pane active" id="tab-pane-customer">
                    <div class="card card-purple card-outline">
                        <div class="card-body">
                            @include('order.includes.createByManager.sender_form')
                        </div>
                    </div>
                </div>
                {{-- add customer  --}}
                ...
                <div class="tab-pane" id="tab-pane-reciver">
                    <div class="card card-purple card-outline">
                        <div class="card-body">
                            @include('order.includes.createByManager.reciver_form')
                        </div>
                    </div>
                </div>
                {{-- add reciver --}}
                ...
                <div class="tab-pane" id="tab-pane-order">
                    <div class="card card-purple card-outline">
                        <div class="card-body">
                            @include('order.includes.createByManager.order_form')
                        </div>
                    </div>
                </div>
                {{-- add order detials --}}
