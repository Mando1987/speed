<form class="OrderFormSubmit" action="{{ route('order.validate_reciver') }}" method="POST">
    ...
    <div class="reciver-info">
        @include('order.includes.progressbar',['title'=> __('site.reciver_info_title'), 'progress' => 50, 'selected' => 2])
            ...
            <div class="col-6 border-left">
                <div class="form-group">
                    ...
                    <div class="form-group row reciverTypeexists reciverType" style="display: none;">
                        ...
                        <div class="col-sm-8">
                            <select class="custom-select" name="reciver[id]" id="allReciversForCustomer">
                           </select>
                        </div>
                    </div>
                </div>
