                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="custom-select" name="order[status]">
                            <option value="phone_from_customer">@lang('site.order_status_phone_from_customer')
                            </option>
                            <option value="customer_store_in_company">
                                @lang('site.order_status_customer_store_in_company')
                            </option>
                        </select>
                    </div>
                </div>
