        ...
        <div class="col-md">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="custom-select" name="order[status]">
                            <option value="under_preparation">@lang('site.order_status_under_preparation') </option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="shipping[price]" value="{{old('shipping.price')}}"
                            class="form-control  @error('shipping.price') is-invalid @enderror" id="order_price"
            ...
            <div class="col-md">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea name="order[info]" class="form-control @error('order.info') is-invalid @enderror"
            ...
            <div class="col-md">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea name="order[notes]" class="form-control  @error('order.notes') is-invalid @enderror"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="shipping[discount]" value="{{old('shipping.discount')}}"
                            class="form-control @error('shipping.discount') is-invalid @enderror" id="order_discount"
