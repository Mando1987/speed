                    ...
                    <div class="order-line">
                        <div class="progress" style="height: 4px">
                            <div class="progress-bar bg-success" role="progressbar"
                                style="@if($userData->adminType =='manager') width: 50% @else width: 0% @endif"
            ...
            <div class="col-6">
                <div class="form-group">
                    <div class="custom-control custom-radio">
                        ...
                        <label for="new" class="custom-control-label">@lang('site.order_create_new_reciver_'
                            .$userData->adminType)</label>
                    </div>
                </div>
            </div>
            <div class="col-6 border-left">
                <div class="form-group">
                    ...
                    <div class="form-group row existsContent" @if($userData->chooseType == 'new') style="display: none"
                        ...
                        <div class="col-sm-8">
                            <x-Recivers name="reciver_id" selected="{{ $userData->existingId }}" adminType="{{$userData->adminType}}" adminId="{{$userData->adminId}}" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <x-input name="reciver[fullname]" value="{{ $userData->fullname}}" placeholder="" />
                        </div>
                    </div>
                </div>
