    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
          <img src="{{asset('assets/dist/img/speedLogo.png')}}" class="user-image img-circle elevation-2" alt="User Image">
        <span class="d-none d-md-inline">{{ adminName() }}</span>
        </a>
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <!-- User image -->
          <li class="user-header bg-primary">
            <img src="{{asset('assets/dist/img/speedLogo.png')}}" class="img-circle elevation-2" alt="User Image">
          ...
          <a href="{{ route('admin.show' , auth('admin')->id()) }}" class="btn btn-default btn-flat">@lang('site.profile')</a>
            <a href="{{ route('admin.logout') }}" class="btn btn-default btn-flat float-right">@lang('site.logout')</a>
          </li>
        </ul>
      </li>
